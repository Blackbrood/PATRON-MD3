...
global.owner = process.env.OWNER_NUMBER || "2348022235091"; // owner number , for multiple number
global.sudo = process.env.SUDO  || "";
global.ownername = process.env.OWNER_NAME || "kingCaesar"; //set bot owner name here 
global.botname = process.env.BOT_NAME || "DEXTER-MD"
global.author = process.env.AUTHOR  || "Patron TechX";
global.packname = process.env.PACK_NAME  || "© DEXTER-MD";
global.session = process.env.SESSION_ID || ""
global.timezone = process.env.TIME_ZONE || "Africa/Lagos";
global.simbol = process.env.SYMBOL || '🐹';
global.thumb = process.env.THUMB || "https://files.catbox.moe/ngp5m3.jpg"
